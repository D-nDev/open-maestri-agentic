...
/// Markdown renderer
/// - Formatted view implements syntax highlighting through NSTextStorage subclass
/// - Support: title (#), code block (```), bold (**), italic (*), table, link
final class MarkdownRenderer {

    // MARK: - Rendered as NSAttributedString
    ...
    private static func renderLine(_ line: String, fontSize: CGFloat) -> NSAttributedString {
        ...
        // Normal text (bold/italic/code handled inline)
    ...
    private static func renderInline(_ text: String, fontSize: CGFloat) -> NSAttributedString {
        ...
        // Simple processing: bold **text**, inline code `code`
        while !remaining.isEmpty {
            if remaining.hasPrefix("**"), let end = remaining.dropFirst(2).range(of: "**") {
                ...
                // Append character by character until special character is encountered
